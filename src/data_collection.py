...
def get_dataset_path():
    """
    ดาวน์โหลด Dataset จาก Kaggle และคัดลอกไฟล์มาไว้ที่ Root Directory ของโปรเจกต์ (นอกโฟลเดอร์ src)
    ...
    # ถอยออกจากโฟลเดอร์ src/ มา 1 ระดับ เพื่อเก็บไว้ข้างนอกสุดของโปรเจกต์
    current_project_dir = Path(os.path.abspath(__file__)).parent.parent
    local_dataset_dir = current_project_dir / 'Dataset-cat-and-dog-image'
    
    # คัดลอกไฟล์ลงโฟลเดอร์โปรเจกต์ด้านนอก
